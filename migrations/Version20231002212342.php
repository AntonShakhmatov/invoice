 ...
 */
final class Version20231002212342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoice_lines CHANGE invoice_id invoice_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoice_lines CHANGE invoice_id invoice_id INT NOT NULL');
    }
}
